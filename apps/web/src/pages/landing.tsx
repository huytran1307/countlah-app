...
export default function LandingPage() {
  ...
  // Check for error from server-side form redirect
  useEffect(() => {
    const params = new URLSearchParams(window.location.search);
    const err = params.get("error");
    if (err === "invalid" || err === "missing") setError("Invalid email or password");
    else if (err === "session") setError("Session error. Please try again.");
  }, []);
